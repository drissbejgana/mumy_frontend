  ...
  return (
    <section id="overview" className="relative min-h-[92vh] flex flex-col justify-center items-center py-20 px-4 grid-bg-pattern bg-brand-dark overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8 relative z-10">
        ...
        <div className="max-w-lg mx-auto bg-red-50 border border-red-200 p-5 rounded-2xl flex items-start gap-4 text-left shadow-lg animate-pulse">
          <div className="p-3 bg-red-100 rounded-xl border border-red-300 text-red-500 shrink-0">
            <ShieldAlert className="w-6 h-6" />
          </div>
          <div>
            <div className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded text-[10px] font-mono bg-red-100 text-red-600 border border-red-300 mb-2 font-bold tracking-wider">
              ⚠ ACCOUNT SUSPENDED
            </div>
            <h4 className="font-space font-extrabold text-gray-900 text-base">Your Etsy store has been deactivated</h4>
            <p className="text-xs text-red-700 font-sans leading-relaxed mt-1">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
          ...
          <button
            ...
            className="w-full sm:w-auto bg-white hover:bg-gray-100 text-gray-800 border border-gray-300 font-space font-medium px-8 py-4 rounded-2xl text-lg transition-colors cursor-pointer inline-flex items-center justify-center gap-2 focus:outline-none shadow-sm"
          >
            Watch Video →
          </button>
        </div>
      ...
      {isVideoModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/85 backdrop-blur-sm">
          ...
          <div className="relative w-full max-w-4xl bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-2xl animate-in fade-in duration-250">
            {/* Header / Close button */}
            <div className="flex items-center justify-between p-4 border-b border-gray-100 bg-gray-50">
              <div className="flex items-center gap-2">
                <img
                  ...
                  draggable={false}
                />
                <span className="text-xs font-mono font-bold text-gray-700">MUMY COMPLIANCE WALKTHROUGH</span>
                <span className="flex items-center gap-1 ml-1 px-1.5 py-0.5 rounded bg-purple-500/15 border border-purple-500/30 text-purple-500 text-[10px] font-sans font-semibold tracking-wide">
              ...
              <button
                ...
                className="p-1.5 px-3 rounded-lg bg-gray-100 hover:bg-red-100 text-gray-500 hover:text-red-500 transition-all font-sans text-xs font-bold flex items-center gap-1 cursor-pointer focus:outline-none"
              >
                Close ✕
              </button>
            </div>
            ...
            <div className="relative pt-[56.25%] w-full bg-black">
              <iframe
                ...
                src="https://www.youtube.com/embed/aOoJOepo4yc?autoplay=1"
...
export function FeaturedOnSection() {
  return (
    <section className="py-10 bg-brand-dark border-b border-gray-200 relative z-10">
...
export function FearSection() {
  return (
    <section className="py-24 bg-brand-dark/90 text-gray-900 border-y border-gray-200 relative z-10">
      <div className="max-w-6xl mx-auto px-4">

        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-1.5 text-red-600 text-xs font-mono font-bold uppercase tracking-widest bg-red-100 border border-red-300 px-3 py-1 rounded-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Col 1 */}
          <div className="p-8 bg-white border border-gray-200 rounded-2xl space-y-4 flex flex-col justify-between hover:border-red-300 transition-all shadow-sm">
            <div className="space-y-3">
              <div className="w-12 h-12 rounded-xl bg-red-100 border border-red-300 flex items-center justify-center text-red-500">
                <ShieldAlert className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-space font-bold text-gray-900">Account Deactivation</h3>
              <p className="text-sm text-gray-600 leading-relaxed font-sans">
                The average seller loses <span className="text-red-500 font-extrabold font-mono">$4,210/month</span> in active sales during a suspension appeal process.
              </p>
            </div>
            <div className="bg-red-50 border border-red-200 p-3.5 rounded-lg text-[10px] font-mono space-y-1.5 mt-2">
              <div className="text-red-500 font-bold">SYSTEM RED BANNER:</div>
              <p className="text-gray-700">"Warning: Shop suspension active due to repeating DMCA notices. Direct deposits are locked."</p>
            </div>
          </div>
          ...
          <div className="p-8 bg-white border border-gray-200 rounded-2xl space-y-4 flex flex-col justify-between hover:border-red-300 transition-all shadow-sm">
            <div className="space-y-3">
              ...
              <h3 className="text-xl font-space font-bold text-gray-900">All Listings Deleted</h3>
              <p className="text-sm text-gray-600 leading-relaxed font-sans">
                Years of SEO backlinks, organic search keywords, review history, and sales rankings wiped clean in a millisecond.
              </p>
            </div>
            <div className="bg-red-50 border border-red-200 p-3.5 rounded-lg text-[10px] font-mono space-y-1.5 mt-2">
              <div className="text-red-500 font-bold">REDBUBBLE INDEX NOTIFICATION:</div>
              <p className="text-gray-700">"Listing 'Cute Green Plumber Retro Cart' deleted under legal copyright representations."</p>
            </div>
          </div>
          ...
          <div className="p-8 bg-white border border-gray-200 rounded-2xl space-y-4 flex flex-col justify-between hover:border-red-300 transition-all shadow-sm">
            <div className="space-y-3">
              ...
              <h3 className="text-xl font-space font-bold text-gray-900">Identity Blacklist</h3>
              <p className="text-sm text-gray-600 leading-relaxed font-sans">
                Once flagged, your bank account details, routing codes, SSN, and IP address are globally blacklisted across all top markets.
              </p>
            </div>
            <div className="bg-red-50 border border-red-200 p-3.5 rounded-lg text-[10px] font-mono space-y-1.5 mt-2">
              <div className="text-red-500 font-bold">AMAZON MERCH REGISTER:</div>
              <p className="text-gray-700">"Registration declined. Associated taxpayer credentials have been locked as fraudulent."</p>
            </div>
          </div>
...
export function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="py-24 bg-brand-dark relative z-10 text-gray-900">
...
export function AgentExplainer() {
  ...
  return (
    <section id="safety-stack" className="py-24 bg-brand-dark border-t border-gray-200 text-gray-900 relative z-10 w-full shrink-0">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {agents.map((a, i) => (
            <div
              key={i}
              className={`p-6 bg-white border border-gray-200 rounded-2xl flex flex-col justify-between hover:border-brand-blue/30 transition-all shadow-sm ${
            ...
            >
              <div className="space-y-3">
                ...
                <p className="text-xs md:text-sm text-gray-600 font-sans leading-relaxed max-w-xl">
                  {a.desc}
                </p>
              </div>
...
export function SocialProof() {
  ...
  return (
    <section className="py-24 bg-brand-dark relative z-10 text-gray-900 border-t border-gray-200">
      <div className="max-w-6xl mx-auto px-4">

        {/* Stat blocks */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20 text-center">
          <div className="p-8 bg-white border border-gray-200 rounded-2xl shadow-sm">
            <div className="font-space font-extrabold text-gray-900 text-4xl md:text-5xl tracking-tight mb-2">12,000+</div>
            <p className="text-xs font-mono text-gray-500 uppercase tracking-widest">Active sellers protected</p>
          </div>
          <div className="p-8 bg-white border border-gray-200 rounded-2xl shadow-sm">
            <div className="font-space font-extrabold text-gray-900 text-4xl md:text-5xl tracking-tight mb-2">540,000+</div>
        ...
        <div className="text-center mb-16 space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-4 text-gray-800 text-xl font-space font-black opacity-30 select-none">
            <span>ETSY</span>
            <span>REDBUBBLE</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {testimonials.map((t, i) => (
            <div key={i} className="p-8 bg-white border border-gray-200 rounded-2xl space-y-4 hover:border-brand-blue/30 transition-all shadow-sm">
              <p className="text-sm md:text-base text-gray-600 italic font-sans leading-relaxed">
                "{t.text}"
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-brand-blue/10 rounded-full flex items-center justify-center font-bold text-[#2323ff]">
                  {t.name[0]}
                </div>
                <div>
...
export function PricingSection({ onSelectPlan }: { onSelectPlan: (plan: string, cycle: "monthly" | "yearly") => void }) {
  ...
  return (
    <section id="pricing" className="py-24 bg-brand-dark/95 text-gray-900 border-t border-gray-200 relative z-10 w-full shrink-0">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          ...
          {/* FREE TIER */}
          <div className="p-8 bg-white border border-gray-200 rounded-2xl flex flex-col justify-between hover:border-gray-300 transition-all shadow-sm">
            <div className="space-y-6">
              <div>
                <span className="text-xs font-mono text-gray-500 uppercase tracking-wider block">INDIVIDUAL SCANNER</span>
                <h3 className="text-2xl font-space font-bold text-gray-900 mt-1">BASIC FREE</h3>
                <p className="text-xs text-gray-500 font-sans mt-0.5">Explore compliance checks.</p>
              </div>

              <div className="space-y-1">
                <div className="text-4xl font-space font-extrabold text-gray-900">$0</div>
                <div className="text-[10px] font-mono text-gray-500 uppercase tracking-widest">No credit card required</div>
              </div>
            ...
            <button
              ...
              className="mt-8 w-full bg-gray-100 hover:bg-gray-200 text-gray-800 border border-gray-300 font-space font-bold py-3.5 rounded-xl text-center self-end cursor-pointer transition-colors"
            >
              Get Started Free →
            </button>
          </div>
          ...
          <div className="p-8 bg-blue-50 border-2 border-[#2323ff] rounded-3xl flex flex-col justify-between hover:scale-[1.02] transition-all relative z-10 shadow-2xl">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-1">
                <div className="text-4xl font-space font-extrabold text-gray-900">
          ...
          <div className="p-8 bg-white border border-gray-200 rounded-2xl flex flex-col justify-between hover:border-gray-300 transition-all shadow-sm">
            <div className="space-y-6">
              <div>
                <span className="text-xs font-mono text-gray-500 uppercase tracking-wider block">HIGH-VOLUME TEAM ARCHITECTURE</span>
                <h3 className="text-2xl font-space font-bold text-gray-900 mt-1">MUMY AGENCY</h3>
                <p className="text-xs text-gray-500 font-sans mt-0.5">Automate bulk listings.</p>
              </div>
...
export function Footer({ onNavigate }: { onNavigate: (path: string) => void }) {
  return (
    <footer className="py-16 bg-brand-dark/95 text-gray-600 border-t border-gray-200 relative z-10 text-sm">
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          <h4 className="text-gray-900 font-space font-bold text-xs uppercase tracking-wider mb-4">Marketplaces We Support</h4>
        ...
        <div>
          <h4 className="text-gray-900 font-space font-bold text-xs uppercase tracking-wider mb-4">Compliance Resources</h4>
          <ul className="space-y-2 text-xs font-sans">
...
export function MarketplacesSection() {
  ...
  return (
    <section id="marketplaces" className="py-24 bg-brand-dark text-gray-900 border-t border-gray-200 relative z-10 w-full shrink-0">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {marketplaces.map((m, idx) => (
            <div
              key={idx}
              className="p-6 bg-white border border-gray-200 rounded-2xl hover:border-brand-blue/30 hover:bg-gray-50 transition-all min-h-[140px] flex flex-col justify-between shadow-sm"
            >
              ...
              <div className="text-[10px] text-gray-400 font-mono pt-3 border-t border-gray-200 mt-3">
                ● {m.type}
              </div>
            </div>
          ))}
